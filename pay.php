...
$checkout_session = \Stripe\Checkout\Session::create([
    "mode" => "payment",
    "success_url" => "http://aws.tzgjim.xyz/rudieta-travel-app/success.php?fullName=$fullName&email=$email&phoneNumber=$phoneNumber&flyers=$flyers&days=$days&from=$from&to=$to&departureDate=$departureDate",
    "locale" => "auto",
    "line_items" => [
        [
            "quantity" => $flyers,
